...
# Environmental
raw_environmental <- read_excel("data-raw/Data/Data - Updated 3-9-22/Environmentals.xlsx")
...
# Raw Catch - ByCatch
raw_bycatch <- read_excel("data-raw/Data/Data - Updated 3-9-22/Raw Catch - ByCatch.xlsx")
...
# Raw Catch - Chinook
raw_chinook <- read_excel("data-raw/Data/Data - Updated 3-9-22/Raw Catch - Chinook.xlsx", col_types = c("date", "numeric", "text", "numeric",
...
raw_steelhead <- read_excel("data-raw/Data/Data - Updated 3-9-22/Raw Catch - Steelhead.xlsx")
raw_steelhead %>%
  mutate(Date = as.Date(Date)) %>%
  glimpse()
...
raw_trap_efficency <- read_excel("data-raw/Data/Data - Updated 3-9-22/Trap Efficiency Release FL.xlsx", col_types = c("numeric", "numeric", "numeric", "text"))
raw_trap_efficency %>%
  glimpse()
...
raw_trap_summary <- read_excel("data-raw/Data/Data - Updated 3-9-22/Trap Efficiency Summary.xlsx")
...
# Trap Operations
raw_trap_operations <- read_excel("data-raw/Data/Data - Updated 3-9-22/Trap Operations.xlsx")
raw_trap_operations %>%
  mutate(Date = as.Date(Date)) %>%
  glimpse()
